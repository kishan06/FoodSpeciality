...
// import 'package:foodspeciality/screens/InsideBottomBar/myProfile/myMoreCompletedChallengess/myMoreCompletedChallengesCard.dart';
...
class MoreCompletedChallenges extends StatefulWidget {
  const MoreCompletedChallenges({super.key});

  @override
  State<MoreCompletedChallenges> createState() => _FollowingState();
}

ScrollController? followingcontroller;

class _FollowingState extends State<MoreCompletedChallenges> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
              itemCount: userDataController.completedChallenge!.data.length,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child: GetBuilder<UserDataController>(builder: (context){
                          final completedChallengeData = userDataController.completedChallenge!.data[index];
                          final recipesShared = userDataController.completedChallenge!.data[index].challengeRecipe;
