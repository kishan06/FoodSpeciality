...
class MoreJoinedChallenges extends StatefulWidget {
  const MoreJoinedChallenges({super.key});

  @override
  State<MoreJoinedChallenges> createState() => _FollowingState();
}

ScrollController? followingcontroller;

class _FollowingState extends State<MoreJoinedChallenges> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
              itemCount: userDataController.joinedChallenge!.data.length,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child: GetBuilder<UserDataController>(builder: (context){
                          final completedChallengeData = userDataController.joinedChallenge!.data[index];
                          final recipesShared = userDataController.joinedChallenge!.data[index].challengeRecipe;
