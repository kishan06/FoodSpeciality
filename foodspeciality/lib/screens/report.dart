...
class _ReportState extends State<Report> {
  List text = [
    ...
    {"title": "Nudity or sexual activity", "image": "assets/Report svg/lock.svg"},
    {"title": "Hate speech of any kind", "image": "assets/Report svg/block.svg"},
    {
    ...
    {"title": "It promotes self-harm or suicide", "image": "assets/Report svg/article.svg"},
    {"title": "It promotes unlawful activity", "image": "assets/Report svg/article.svg"},
                          ...
                          itemBuilder: (context, index) {
                            return InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    textgreyM16Robo(text[index]['title']),
                                  ],
                                ),
                              )
                              // Text(
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                        text: " to see the content that is prohibited on our platform. Reporting is anonymous.",
                        style: TextStyle(
                          color: AppColors.black,
                          fontSize: 14.sp,
                          fontFamily: "Roboto"
