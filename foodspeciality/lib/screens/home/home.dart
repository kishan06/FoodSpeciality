...
import 'package:foodspeciality/screens/home/common/list_card.dart';
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: Stack(
            children: [
              Image.asset("assets/home/tab1_image.png",
              ...
              Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: textL_grey14Robo("Create your community and connect with your friends, family, chefs and other aspiring cooks."),
                  ),
